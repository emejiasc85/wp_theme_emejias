<?php
/**
 * emejias functions and definitions
 *
...
if ( ! function_exists( 'emejias_setup' ) ) :
	/**
	...
	function emejias_setup() {
		 ...
		 * If you're building a theme based on emejias, use a find and replace
		 * to change 'emejias' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'emejias', get_template_directory() . '/languages' );
		...
		function emejias_custom_logo_setup() {
			$defaults = array(
				'height'      => 50,
				'width'       => 30,
				'flex-height' => true,
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'emejias' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'emejias_custom_background_args', array(
...
add_action( 'after_setup_theme', 'emejias_setup' );
 ...
 */
function emejias_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'emejias_content_width', 640 );
}
add_action( 'after_setup_theme', 'emejias_content_width', 0 );
 ...
 */
function emejias_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'emejias' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'emejias' ),
...
add_action( 'widgets_init', 'emejias_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'emejias_scripts' );
